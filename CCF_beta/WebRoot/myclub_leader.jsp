		...
		function loadMemberList() {
			$.ajax( {
				...
				$.each(data, function(index, member) {
					$("#leader_list").before("<dd><div class=\"default\"><span class=\"username\">" + member.username + "</span><span class=\"link\"><a href=\"profile?account=" + member.useraccount + "\">H</a><a id=\"personelChange\" href=\"personelChange?cid=${clubinfo.cid}&account=" + member.useraccount + "\">C</a><a href=\"deleteStaff?cid=${clubinfo.cid}&account=" + member.useraccount + "\">D</a></span></div></dd>");
