...
<html>
  <head>
    ...
    <title>My JSP 'stev_club_setting.jsp' starting page</title>
  ...
  <body>
	...
	<s:form  action="updateClubProfile">
    	...
    	<input type="button" value="Change Club's Portrait(simulation)">
  		...
  		<s:textfield name="club.cid" label="Club id" value="%{club.cid}" />
  		<s:textfield name="club.c_name" label="Club Name" value="%{club.c_name}"></s:textfield>
		<s:textfield name="club.c_field" label="Current Leader" value="%{club.c_code_current_leader}" />
